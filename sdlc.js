...
const analysis = 'determine needed tech stack for required features'
const Design = 'UX UI'
const Implementation = 'coding'
const testingAndInt = 'checking for bugs deployment'
const Maintain = 'continuing'